...
import tn.esprit.kidzone.services.IListParticipantsService;;
...
public class ListParticipantsController {
	...
	@ResponseBody
	public void Participer(@PathVariable("iduser") Long userId, @PathVariable("idevent") int eventId) {
	...
	@ResponseBody
	public List<Event> getAllEventByUser(@PathVariable("iduser") Long userId) {
